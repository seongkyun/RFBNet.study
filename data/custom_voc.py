...
class AnnoTransform_custom(object):
...
class CustomDetection(data.Dataset):
    ...
    def __init__(self, root, image_sets, preproc=None, target_transform=None,
        ...
        #print(self.root) #/mnt/hdd640/drone_even_trainset
        #print(self.image_set) #Customset
        #print(self.preproc) # address
        #print(self.target_transform) # address
        #print(self.name) #images
        #print(self._annopath) # %s/annotations/%s.xml
        #print(self._imgpath) # %s/images/%s.jpg
        self.ids = list()
        ...
        for line in open(os.path.join(self.root, "trainval.txt")):
